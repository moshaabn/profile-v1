  ...
  return (
    <section id="skills" className={`container mx-auto px-6 py-20 lg:py-32 ${tw.bg.overlay}`}>
      <div className="max-w-6xl mx-auto">
        <h3 className="text-3xl lg:text-4xl font-bold mb-16 text-center font-heading">Technical Skills</h3>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className={`${tw.bg.card} p-8 rounded-2xl card-hover`}>
            <h4 className={`text-2xl font-semibold mb-6 ${tw.text.primary} font-heading`}>Frontend</h4>
            <ul className={`space-y-3 ${tw.text.secondary} font-body text-lg`}>
              <li className="flex items-center">
                <span className={`w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0`}></span>
          ...
          <div className={`${tw.bg.card} p-8 rounded-2xl card-hover`}>
            <h4 className={`text-2xl font-semibold mb-6 ${tw.text.primary} font-heading`}>Database & Tools</h4>
            <ul className={`space-y-3 ${tw.text.secondary} font-body text-lg`}>
              <li className="flex items-center">
                <span className={`w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0`}></span>
                MySQL, MongoDB
          ...
          <div className={`${tw.bg.card} p-8 rounded-2xl card-hover`}>
            <h4 className={`text-2xl font-semibold mb-6 ${tw.text.primary} font-heading`}>Frameworks & Integration</h4>
            <ul className={`space-y-3 ${tw.text.secondary} font-body text-lg`}>
              <li className="flex items-center">
                <span className={`w-2 h-2 bg-emerald-500 rounded-full mr-3 flex-shrink-0`}></span>
                ABP Framework
